...
if cookies:
    cookies = cookies["_xsrf"][-10:-1]
    make_dir(cookies)
    st.title('A tool for table recognition')
    ...
    if uploaded_pic is not None:
        ...
        if idx is not None:
            ...
            model_choose = st.selectbox('Model', ('Sequence2Sequence', 'Instance segmentation'))
            if model_choose == 'Sequence2Sequence':
