...
class Table(Element):
    ...
    def __init__(self, table):
        """
        takes an html download object (from lxml)
        """
...
class TableHead(Element):
    """
    This class maps to the `<th>` element of the html download.
    """
...
class TableBody(Element):
    """
    This class maps to the `<tbody>` element of the html download.
    """
...
class TableRow(Element):
    """
    This class maps to the `<tr>` element of the html download.
    """
...
class TableCell(Element):
    """
    This class maps to the `<td>` element of the html download.
    """
